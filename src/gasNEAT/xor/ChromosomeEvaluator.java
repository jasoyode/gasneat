...
private final static Logger logger = Logger.getLogger( ChromosomeEvaluator.class );
...
public static void main( String[] args ) throws Exception {
	...
	String type = props.getProperty( TYPE_KEY, GASNEAT_TYPE );
	
	Configuration config = new DummyConfiguration();
	
	if (   type.equals( GASNEAT_TYPE )  ) {
		config = new GasNeatConfiguration(props );
	} else if (  type.equals(ANJI_TYPE) ) {
