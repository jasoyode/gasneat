...
public class AplysiaEvaluator {

private final static Logger logger = Logger.getLogger( AplysiaEvaluator.class );
...
public static void main( String[] args ) throws Exception {
	AplysiaFitnessFunction ff = new AplysiaFitnessFunction();
