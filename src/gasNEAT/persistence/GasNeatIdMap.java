...
public class GasNeatIdMap {
	 ...
	 */
	public final static String GASNEAT_ID_MAP_FILE_KEY = "gasneat.id.file";

	/**
	 * base XML tag for GasNEAT ID mapping
	 */
	public final static String GASNEAT_ID_MAP_XML_TAG = "gasneat_id_map";

	/**
	 * XML tag for GasNEAT ID mapping, neuron ID
	 */
	public final static String NEURON_ID_MAP_XML_TAG = "neuron_id_map";

	/**
	 * XML tag for GasNEAT ID mapping,connection ID
	 */
	public final static String CONNECTION_ID_MAP_XML_TAG = "connection_id_map";

	/**
	 * XML tag for GasNEAT ID mapping, neuron
	 */
	public final static String CONNECTION_TO_NEURON_XML_TAG = "neuron";

	/**
	 * XML tag for GasNEAT ID mapping, innovation ID
	 */
	...
	/**
	 * XML tag for GasNEAT ID mapping, connection
	 */
	public final static String CONNECTION_TO_CONNECTION_XML_TAG = "connection";

	/**
	 * XML tag for GasNEAT ID mapping, source neuron ID
	 */
	public final static String SRC_NEURON_ID_XML_TAG = "src_neuron_id";

	/**
	 * XML tag for GasNEAT ID mapping, destination neuron ID
	 */
	public final static String DEST_NEURON_ID_XML_TAG = "dest_neuron_id";

	
	//TODO: Need to add receptor_id possibly? Will that count as a historical ID?
	...
	private String gasNeatIdMapFileName = null;
	 ...
	 */
	public GasNeatIdMap( Properties newProps ) {
		super();
		init( newProps );
	}
	...
	private void init( Properties props ) {
		gasNeatIdMapFileName = props.getProperty( GASNEAT_ID_MAP_FILE_KEY, null );
	}
	 ...
	 * @param newNeuronId
	 */
	public void putNeuronId( Long connectionId, Long newNeuronId ) {
	 ...
	 */
	public void putConnectionId( Long srcNeuronId, Long destNeuronId, Long newConnectionId ) {
	...
	public void load() throws IOException {
		if ( gasNeatIdMapFileName != null ) {
			FileInputStream in = null;
			try {
				in = new FileInputStream( gasNeatIdMapFileName );
				neatIdMapFromXml( in );
			}
			catch ( Exception e ) {
	...
	public boolean store() throws IOException {
		if ( gasNeatIdMapFileName != null ) {
			FileWriter out = null;
			try {
				out = new FileWriter( gasNeatIdMapFileName );
				out.write( toXml() );
				out.flush();
				return true;
			}
	...
	/**
	 * Convert GASNEAT ID mappings (enables re-use of innovation IDs) to XML string.
	 * 
	 * @return XML string
	 */
	public String toXml() {
		StringBuffer result = new StringBuffer();
		result.append( "<" ).append( GASNEAT_ID_MAP_XML_TAG ).append( ">\n" );
	...
	private void neatIdMapFromXml( InputStream in ) throws Exception {
		...
		if ( GASNEAT_ID_MAP_XML_TAG.equals( node.getNodeName() ) == false )
			throw new IllegalArgumentException( "tag != " + GASNEAT_ID_MAP_XML_TAG );
