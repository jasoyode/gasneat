 ...
 */
public class FoodAndWaterTaskDisplay extends JFrame {
...
private FoodAndWaterTaskCanvas poleBalanceCanvas;
 ...
 * @param aMaxSteps
 */
public FoodAndWaterTaskDisplay( double aTrackLength, double[] aPoleLengths, int aMaxSteps ) {
	super( NAME );
...
private void init( double aTrackLength, double[] aPoleLengths, int aMaxSteps ) {
	...
	// 3 - surface canvas
	poleBalanceCanvas = new FoodAndWaterTaskCanvas( aTrackLength, aPoleLengths );
