 ...
 */
public class GasNeatWeightMutationOperator extends WeightMutationOperator {

/**
 * properties key, perturb weight mutation rate
 */
public static final String WEIGHT_MUTATE_RATE_KEY = "gasneat.weight.mutation.rate";

/**
 * properties key, standard deviation of perturb weight mutation
 */
private static final String WEIGHT_MUTATE_STD_DEV_KEY = "gasneat.weight.mutation.std.dev";
 ...
 */
public GasNeatWeightMutationOperator() {
 ...
 */
public GasNeatWeightMutationOperator( float newMutationRate ) {
 ...
 * @see MutationOperator#MutationOperator(float)
 */
public GasNeatWeightMutationOperator( float newMutationRate, float newStdDev ) {
