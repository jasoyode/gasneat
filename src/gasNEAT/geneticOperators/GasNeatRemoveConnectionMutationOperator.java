 ...
 */
public class GasNeatRemoveConnectionMutationOperator extends RemoveConnectionMutationOperator {
 ...
 */
public static final String REMOVE_CONN_MAX_WEIGHT_KEY = "gasneat.remove.connection.max.weight";

/**
 * properties key, remove connection mutation rate
 */
public static final String REMOVE_CONN_MUTATE_RATE_KEY = "gasneat.remove.connection.mutation.rate";
 ...
 */
public GasNeatRemoveConnectionMutationOperator() {
 ...
 */
public GasNeatRemoveConnectionMutationOperator( float aMutationRate ) {
	super( aMutationRate );
}
 ...
 * @see MutationOperator#MutationOperator(float)
 */
public GasNeatRemoveConnectionMutationOperator( float aMutationRate, float aMaxWeightRemoved ) {
	super( aMutationRate );
