 ...
 * for hibernate
 */
//made public for mocking in ann_integration
public ChromosomeMaterial() {
 ...
 */
public List extractExcessAlleles( Collection alleles, long threshold ) {
 ...
 * @param aAlleles
 */
public void setAlleles( SortedSet aAlleles ) {
	m_alleles = aAlleles;
}
