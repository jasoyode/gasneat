 ...
 */
final public void reproduce( final Configuration config, final List parentSpecies, List offspring, int currentGeneration, int maxGenerations ) 
	throws InvalidConfigurationException
{
	...
	if ( targetNewOffspringCount > 0 ) {
		...
		while ( specieIter.hasNext() ) {
			...
			reproduce( config, specie.getChromosomes(), numSpecieOffspring, newOffspring, currentGeneration, maxGenerations  );
		}
 ...
 */
protected abstract void reproduce( final Configuration config, final List parents, int numOffspring, List offspring, int generation, int maxGenerations ) 
	throws InvalidConfigurationException;
