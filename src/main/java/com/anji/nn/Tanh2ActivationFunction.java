 ...
 */
public class Tanh2ActivationFunction implements ActivationFunction {

	/**
	 * identifying string
	 */
	public final static String NAME = ActivationFunctionType.TANH2.toString();
	...
	public double apply( double input ) {
		...
		//mimicking Soltoggios activation function
		return Math.tanh(input/2 );
	}
