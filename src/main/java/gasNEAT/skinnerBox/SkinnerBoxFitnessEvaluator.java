...
public class SkinnerBoxFitnessEvaluator {

private final static Logger logger = Logger.getLogger( SkinnerBoxFitnessEvaluator.class );
...
public static void main( String[] args ) throws Exception {
	SkinnerBoxFitnessFunction ff = new SkinnerBoxFitnessFunction();
