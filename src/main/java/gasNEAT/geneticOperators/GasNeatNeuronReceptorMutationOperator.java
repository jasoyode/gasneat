 ...
 * @author Jason Yoder
 */
public class GasNeatNeuronReceptorMutationOperator extends MutationOperator implements Configurable {
	/**
	 * properties key, perturb weight mutation rate
	 */
	public static final String NEURON_RECEPTOR_MUTATE_RATE_KEY = "gasneat.neuron.receptor.mutation.rate";
	...
	public void init( Properties props ) throws Exception {
		setMutationRate( props.getFloatProperty( NEURON_RECEPTOR_MUTATE_RATE_KEY, DEFAULT_MUTATE_RATE ) );
	}
	
	/**
	 * @see MutationOperator#MutationOperator(float)
	 */
	public GasNeatNeuronReceptorMutationOperator() {
	 ...
	 */
	public GasNeatNeuronReceptorMutationOperator( float newMutationRate ) {
