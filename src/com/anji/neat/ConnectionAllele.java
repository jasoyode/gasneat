 ...
 */
public final static double DEFAULT_WEIGHT = 0.0d;

private final static double MIN_INIT_WEIGHT = -1.0d;

private final static double MAX_INIT_WEIGHT = 1.0d;
...
public double distance( Allele target ) {
	...
	double ret= Math.abs( weight - ( (ConnectionAllele) target ).getWeight() );
	//System.out.println("Distance is: "+ret +" between" + target + " " +toString() );
	return ret;
}
